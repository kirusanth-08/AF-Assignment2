...
const Menu = () => {
  ...
  return (
    <div className='bg-blurred w-full flex items-center justify-center h-screen' name='menu'>
        <Link to="/apod" className='relative w-1/4 h-3/6 rounded-xl overflow-hidden bg-black my-6 mr-10 border-2 border-opacity-50 border-yellow-50 hover:w-1/2 transition-all duration-500'>
