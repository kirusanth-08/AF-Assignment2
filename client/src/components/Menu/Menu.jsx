...
const Menu = () => {
  return (
    <div className='menu w-full flex items-center justify-center h-screen' name='menu'>
        ...
        <Link to="/mars" className='relative w-1/4 h-3/6 rounded-xl overflow-hidden bg-black my-6 ml-10 border-2 border-opacity-50 border-yellow-50 hover:w-1/2 transition-all duration-400'>
